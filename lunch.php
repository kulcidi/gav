		...
		<main>
			<section class="deliv">
				...
				<div class="deliv_info">
					<h4>
						• Бизнес-ланчи - выгодная возможность для коллектива на работе попробовать разные блюда
					</h4>
					<h4>
						• Доставляются с 12:00 до 15:00.
Заказы принимаются с 11:00
					</h4>
					<h4>• Минимальное количество ланчей - 5 штук</h4>
				</div>
				<div class='heho'>
				<button class="bub"><a href="menu.php"><h2>Перейти в меню</h2></a></button></div>
